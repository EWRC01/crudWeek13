...
<button type="button" class="btn btn-dark" data-toggle="modal" data-target="#myModal">Add student</button>
<hr/>
<!--Modal-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title">Registra un nuevo estudiante</h5>
...
@error('Score3') <span class="text-danger">{{$message}}</span>@enderror
      ...
      <button class="btn btn-danger" wire:click.prevent="store()" type="button">Guardar</button>
